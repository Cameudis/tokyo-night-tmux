...
lesson_status="#($SCRIPTS_PATH/lesson-status.sh #{pane_current_path})"
...
#+--- Bars RIGHT ---+
tmux set -g status-right "$cmus_status#[fg=#a9b1d6,bg=#24283B]$netspeed$git_status$wb_git_status$date_and_time$lesson_status"
